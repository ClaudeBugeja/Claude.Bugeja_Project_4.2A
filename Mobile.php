...
<html>
    ...
    <br/>
        ...
        <div class="col-lg-8 col-sm-8 col-md-8" style="text-align: center;">
        ...
        <div class="col-lg-2 col-md-4" style="margin-left:10.5%; margin-top:5%; background-color:white; height:100%;">
             <?php
                ...
                if(mysqli_num_rows($result) > 0) {
                    ...
                    echo "<hr>";
                    echo "   <form action='Mobile.php' method='post'><img src='images/bag-logo-black.png' width='20' height='20'><input type='submit' class='btn btn-primary' style='margin-left:5%; margin-right:5%;' name='Submit' value='Add'></form>";
