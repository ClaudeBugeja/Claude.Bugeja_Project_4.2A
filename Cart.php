...
<html>
    ...
    <br/>
<br/>
        <h3 style="margin-left:2%;"><?php echo "$_SESSION[name]" ?>'s Cart</h3>
        <br/>
        <br/>
        <div class="col-lg-12" style="width:100%; padding-left:2%; padding-right:2%;">
					...
					<tr>
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                $query1 = "Select ProductName, Price, Image from product where ProductID = '$row[ProductID]'";
        ...
        <br/>
        <br/>
        <div id="paypal-button" style="padding-left:2%;"></div>
        <div id="paypal-success" style="padding-left:2%; color:green;"></div>
        <div id="paypal-es" style="padding-left:2%; color:green;"></div>
  ...
  <script>
      ...
      paypal.Button.render({
        ...
        client: {
            sandbox:    'AW8bRhCm6WrpOnjPN1wfKNSXBcZZJTkIJtZUOfPlBV0EIMHYT5cVU8HAyctOBwANOwBQ1pugF-07lsBF',
            production: 'AW8bRhCm6WrpOnjPN1wfKNSXBcZZJTkIJtZUOfPlBV0EIMHYT5cVU8HAyctOBwANOwBQ1pugF-07lsBF'
        },
        ...
        onAuthorize: function(data, actions) {
            return actions.payment.execute().then(function(payment) {
                ...
                document.getElementById('paypal-success').innerHTML="Payment Successfull";
